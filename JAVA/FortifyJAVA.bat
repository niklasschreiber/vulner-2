...
REM Created on 2022/04/02 10:53:46
REM ###########################################################################
...
set FPR="FortifyJAVA.fpr"
set BUILDID="JAVA"
set ARGFILE="FortifyJAVA.bat.args"
set BYTECODE_ARGFILE="FortifyJAVA.bat.bytecode.args"
set MEMORY=-Xmx29356M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set SCANSWITCHES=""
set OLDFILENUMBER="FortifyJAVA.bat.fileno"
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="D:\_SRC\BUGGYCODE\JAVA"
...
:FINISHED
REM ARGS "-cp"
REM ARGS "PROJECTROOT0_MARKER\lib\junit.jar;PROJECTROOT0_MARKER\lib\servlet.jar;PROJECTROOT0_MARKER\lib\gnujaxp.jar;PROJECTROOT0_MARKER\lib\jcommon-1.0.12.jar;PROJECTROOT0_MARKER\lib\itext-2.0.6.jar"
REM ARGS "-source"
REM ARGS "1.8"
